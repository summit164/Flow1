  ...
  return (
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 flex">
      ...
      <div className="bg-white shadow-xl w-full max-w-md h-full flex flex-col">
        ...
        {/* Итого и кнопки */}
        {cartItems.length > 0 && (
          <div className="p-4 border-t border-gray-200 bg-gray-50 flex-shrink-0 max-h-96 overflow-y-auto">
            ...
            {/* Кнопки */}
            <div className="flex flex-col gap-3 mt-4 sticky bottom-0 bg-gray-50 pt-4 border-t border-gray-300">
              <Button
              ...
              <Button
                ...
                variant="outline"
                className="w-full bg-red-50 border-red-200 text-red-700 hover:bg-red-100 hover:border-red-300 py-2"
              >
                🗑️ Очистить корзину
              </Button>
            </div>
